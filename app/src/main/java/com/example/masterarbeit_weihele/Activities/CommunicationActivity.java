...
public class CommunicationActivity extends WakeLockActivity implements OnContactClickListener {
    ...
    //Tokens
    private static final String ALL_CHANNEL_TOKEN = "HierTokenEinsetzen";
    private static final String LEADER_CHANNEL_TOKEN = "HierTokenEinsetzen";
    private static final String USER_JONAS_CHANNEL_TOKEN = "HierTokenEinsetzen";
    private static final String USER_SABRINA_CHANNEL_TOKEN = "HierTokenEinsetzen";
    private static final String USER_ALEX_CHANNEL_TOKEN = "HierTokenEinsetzen";
